...
const Catering = () => {
    ...
    const [activeSection, setActiveSection] = useState(() => localStorage.getItem('catering_active_tab') || 'breakfast');

    const handleSectionSelect = (type) => {
        setActiveSection(type);
        localStorage.setItem('catering_active_tab', type);
    };
                ...
                >
                    {loading ? (
                        <div className="col-span-full py-16 text-center">
                            ...
                            <p className="text-gray-400 font-semibold tracking-wider text-sm uppercase">Loading Catering Menu...</p>
                        </div>
                    ) : (
                        <>
